...
namespace SportEvent.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataContext>(x => {
                x.UseSqlServer(
                                ConnectionString,
                                y => {
                                    y.MigrationsAssembly("SportEvent.API");
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SportEvent.API", Version = "v1" });
            ...
            services.AddTransient<OrganizerManager>();
            services.AddTransient<EventSportManager>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "SportEvent.API V1");
            });
